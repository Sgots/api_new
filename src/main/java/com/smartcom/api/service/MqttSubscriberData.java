...
public class MqttSubscriberPool {
    ...
    public void run() throws Exception {
        ...
        subClient.setCallback(new MqttCallback() {
            ...
            /*  String messages = mqttMessage.toString();
                ...
                switch (command) {
                    case "dataResponse": {
                        if (json.getString("deviceTypeID").equals("1") || json.getString("deviceTypeID").equals("2")) {
...
//                    int country = Integer.parseInt((String) json.get("power"));
                    ...
                    /*    try {
                         ...
                         /*   pstmt = con.prepareStatement("INSERT INTO  recharge_response values (?,?,?,?,?,?,?,?,?,?)");
                            ...
                            pstmt.setTimestamp(3, timestamp2);
...
/*
                    ...
                    case "notificationsResponse": {
                        ...
                        Boolean onlineState = json.getBoolean("onlineState");
                        String device = json.getString("deviceID");
                        ...
                        deviceService.addNotifications(notifications, onlineState);
